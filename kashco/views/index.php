...
<body>
  <section class="banner">
    <img src="../public/assets/img/images.png" alt="Banner">
...
<section class="products">
  <?php while ($produto = $result->fetch_assoc()): ?>
    ...
    <div class="product">
      ...
      <button class="add-to-cart" data-id="<?= $produto['id'] ?>" data-nome="<?= $produto['nome'] ?>" data-preco="<?= $produto['preco'] ?>">Adicionar ao Carrinho</button>
    </div>
  <?php endwhile; ?>
</section>
